export function buildRequirementsExtractionPrompt(args: {
  ...
  return [
    ...
    "Every requirement MUST use exactly one status from: verified, blocked, review, missing, locked.",
    "Every requirement MUST use exactly one verificationStatus from: known, unverified, unknown, conflicted.",
    "Every requirement MUST include isPrimaryBlocker as a boolean (true for at most one setback/zoning blocker).",
